<template>
  <div class="page-layout">
    ...
    <div v-else>
      ...
      <div class="kpi-row">
        <KpiCard :value="$$(totalGeneral)" label="Costo Total General" accent="#15223c" icon="dollar" :detail="`<span class='kpi-detail-int'><span class='kpi-dot' style='background:#3B82F6'></span>Int: <strong>${$$short(intTotal)}</strong> (${intPct}%)</span><span class='kpi-sep'>·</span><span class='kpi-detail-ext'><span class='kpi-dot' style='background:#10B981'></span>Ext: <strong>${$$short(extTotal)}</strong> (${extPct}%)</span>`" />
        <KpiCard :value="$$(servicios)" label="Costos Servicios" accent="#3B82F6" icon="settings" :detail="`<span class='kpi-detail-int'><span class='kpi-dot' style='background:#3B82F6'></span>Int: <strong>${$$short(intServ)}</strong></span><span class='kpi-sep'>·</span><span class='kpi-detail-ext'><span class='kpi-dot' style='background:#10B981'></span>Ext: <strong>${$$short(extServ)}</strong></span>`" />
        <KpiCard :value="$$(insumos)" label="Costos Insumos" accent="#EF4444" icon="package" :detail="`<span class='kpi-detail-int'><span class='kpi-dot' style='background:#3B82F6'></span>Int: <strong>${$$short(intIns)}</strong></span><span class='kpi-sep'>·</span><span class='kpi-detail-ext'><span class='kpi-dot' style='background:#10B981'></span>Ext: <strong>${$$short(extIns)}</strong></span>`" />
        <KpiCard :value="fmt(totalProd) + ' m³'" label="Total Producción" accent="#10B981" icon="trending-up" />
        <KpiCard :value="$$(costoM3)" label="Costo por m³" :accent="costoM3 > 3000 ? '#EF4444' : '#10B981'" :meta="'Meta: $3.000/m³'" icon="target" :detail="`<span class='kpi-detail-int'><span class='kpi-dot' style='background:#3B82F6'></span>Int: <strong>${$$short(intCostoM3)}/m³</strong></span><span class='kpi-sep'>·</span><span class='kpi-detail-ext'><span class='kpi-dot' style='background:#10B981'></span>Ext: <strong>${$$short(extCostoM3)}/m³</strong></span>`" />
        <KpiCard :value="String(totalOrdenes)" label="Total Órdenes" accent="#8B5CF6" icon="list" :detail="`<span class='kpi-detail-int'><span class='kpi-dot' style='background:#3B82F6'></span>Int: <strong>${intCount}</strong></span><span class='kpi-sep'>·</span><span class='kpi-detail-ext'><span class='kpi-dot' style='background:#F59E0B'></span>Ext: <strong>${extCount}</strong></span>`" />
        <KpiCard :value="String(estadoCounts.abiertas)" label="Abiertas" accent="#EF4444" icon="activity" :detail="`<span class='kpi-detail-int'><span class='kpi-dot' style='background:#3B82F6'></span>Int: <strong>${otsIntEstadoCounts.abiertas}</strong></span><span class='kpi-sep'>·</span><span class='kpi-detail-ext'><span class='kpi-dot' style='background:#F59E0B'></span>Ext: <strong>${otsExtEstadoCounts.abiertas}</strong></span>`" />
        <KpiCard :value="String(estadoCounts.cerradas)" label="Cerradas" accent="#10B981" icon="check-circle" :detail="`<span class='kpi-detail-int'><span class='kpi-dot' style='background:#3B82F6'></span>Int: <strong>${otsIntEstadoCounts.cerradas}</strong></span><span class='kpi-sep'>·</span><span class='kpi-detail-ext'><span class='kpi-dot' style='background:#F59E0B'></span>Ext: <strong>${otsExtEstadoCounts.cerradas}</strong></span>`" />
        <KpiCard :value="otPctCierre + '%'" label="% Cierre" accent="#3B82F6" icon="zap" :detail="`<span class='kpi-detail-int'><span class='kpi-dot' style='background:#3B82F6'></span>Int: <strong>${otsIntPctCierre}%</strong></span><span class='kpi-sep'>·</span><span class='kpi-detail-ext'><span class='kpi-dot' style='background:#F59E0B'></span>Ext: <strong>${otsExtPctCierre}%</strong></span>`" />
        <KpiCard :value="otDuracionEstimadaProm + ' h'" label="Duración Estimada Promedio" accent="#8B5CF6" icon="clock" :detail="`<span class='kpi-detail-int'><span class='kpi-dot' style='background:#3B82F6'></span>Int: <strong>${otsIntDuracionEstimadaProm}h</strong></span><span class='kpi-sep'>·</span><span class='kpi-detail-ext'><span class='kpi-dot' style='background:#F59E0B'></span>Ext: <strong>${otsExtDuracionEstimadaProm}h</strong></span>`" />
        <KpiCard :value="otTiempoRealProm + ' h'" label="Tiempo Real Recepción → Cierre" accent="#06B6D4" icon="target" :detail="`<span class='kpi-detail-int'><span class='kpi-dot' style='background:#3B82F6'></span>Int: <strong>${otsIntTiempoRealProm}h</strong></span><span class='kpi-sep'>·</span><span class='kpi-detail-ext'><span class='kpi-dot' style='background:#F59E0B'></span>Ext: <strong>${otsExtTiempoRealProm}h</strong></span>`" />
        <KpiCard :value="otConSopledPct + '%'" label="OT con Solicitud (SOPLED/Interno)" accent="#10B981" icon="package" :detail="`<span class='kpi-detail-int'><span class='kpi-dot' style='background:#3B82F6'></span>Int: <strong>${otsIntConSopledPct}%</strong></span><span class='kpi-sep'>·</span><span class='kpi-detail-ext'><span class='kpi-dot' style='background:#F59E0B'></span>Ext: <strong>${otsExtConSopledPct}%</strong></span>`" />
      </div>
