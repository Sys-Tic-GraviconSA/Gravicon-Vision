...
const repConclusiones = computed((): ConclusionGrupo[] => {
  ...
  costos.push(`Producción total del período: ${fmt(totalProd.value)} m³, con un costo de mantenimiento de ${$$(costoM3.value)}/m³ ${costoM3.value > metaM3.value ? `(por encima de la ${metaM3Label.value.toLowerCase()})` : `(dentro de la ${metaM3Label.value.toLowerCase()})`}.`)
  ...
  if (costoM3.value > metaM3.value) alertas.push(`El costo por m³ (${$$(costoM3.value)}) supera la ${metaM3Label.value.toLowerCase()}.`)
